  ...
  return (
    <Layout>
      <div className="flex flex-col gap-y-4">
        ...
        <p>
          Note that some data like star X, Y coordinates, and the neighbor
          information was calculate from Jupyter Notebook. (
          <a
            href="https://github.com/LutherAstrophysics/suman-analysis/blob/main/stats/stats.ipynb"
            className="text-blue-600"
          >
            see here
          </a>
          ). This data is then saved statically on the frontend itself. This
          means that you must change the source code of this repo (check the
          file utils/info.js).{" "}
        </p>
        <div>
          ...
          <ol className="list-decimal list-inside">
            ...
            <li>
              Either restart the computer or type <pre> restart-frontend</pre>{" "}
              to rebuild the frontend page with updated data. If you choose the
              latter, you should not close the process and do other works you
              may have in a new terminal.
            </li>
